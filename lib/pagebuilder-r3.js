...
function showAdvanceBox() {
    ...
    msg += "<ul>";
    msg += "<li>アドバンス・トップエスイーのカリキュラムは<a href='curriculum.html#advance' target='_blank'>こちら</a>をご覧ください．募集要項は<a href='admission-application.html' target='_blank'>こちら</a>です．<a href='topse2017.pdf' target='_blank'>2017年度向けのトップエスイープログラムのご案内</a>もご覧ください．</li>";
