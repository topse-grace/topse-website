...
function showAdvanceBox() {
    ...
    msg += "<ul>";
    msg += "<li>アドバンス・トップエスイーに関する情報は，随時Webサイトでお知らせします．<a href='curriculum.html' target='_blank'>こちら</a>にカリキュラムの説明があります．募集要項は<a href='admission-application1.html' target='_blank'>こちら</a>です．<a href='topse2017.pdf' target='_blank'>2017年度向けのトップエスイープログラムのご案内</a>もご覧ください．</li>";
