...
INTERMediatorOnPage.doAfterConstruct = function () {
    ...
    if(INTERMediatorOnPage.appendDoAfterConstruct)  {
        INTERMediatorOnPage.appendDoAfterConstruct();
    }
};
...
function showAdvanceBox() {
    ...
    msg += "<table>";
    msg += "<tr><th style='white-space:nowrap'>プロフェッショ<br>ナルスタディ</th>";
    msg += "<td>開発現場での困難な問題の分析，課題設定，解決策の創出，実行，評価，展開 を，講師が1対1で指導する．博士課程進学希望者には，論文の執筆を指導する．</td></tr>";
    msg += "<tr><th style='white-space:nowrap'>最先端ソフトウェア<br>工学ゼミ</th>";
    msg += "<td>全受講生と複数の講師が，開発現場の問題解決に役立つ最先端ソフトウェア技術を1年にわたり調査・試行・報告・議論し，最先端の知見を共有する．</td></tr>";
    msg += "<tr><th style='white-space:nowrap'>最先端の技術を<br>学習できる講義</th>";
    msg += "<td>ソフトウェア工学での必須の知識や最先端の情報を，トップエスイーの講義として提供可能．専門知識の高度化や，自分にとって新しいジャンルへのチャレンジにも最適な講義群を用意した．</td></tr></table>";
    msg += "<ul>";
    msg += "<li>アドバンス・トップエスイーのカリキュラムは<a href='curriculum.html#advance' target='_blank'>こちら</a>をご覧ください．募集要項は<a href='admission-application1.html' target='_blank'>こちら</a>です．<a href='topse2017.pdf' target='_blank'>2017年度向けのトップエスイープログラムのご案内</a>もご覧ください．</li>";
...
function showSyllabus(c)    {
    window.open("curriculum-lectures.html?c="+c);
}
