...
var number = Math.floor(Math.random() * students.length);
if (number < students.length) {
    document.getElementById("studentName").textContent = students[number].name;
    document.getElementById("studentOrganization").textContent = students[number].organization;
    document.getElementById("studentComment").textContent = students[number].comment;
    document.getElementById("studentImg").src = "../images/students/" + students[number].imgpath;
}
